...
public class ClienteDaoImpl extends BaseDaoImpl<Cliente, Long> 
    ...
    public List<Cliente> pesquisarPorNome(String nome,
        ...
        Query<Cliente> consulta = session
                .createQuery("from Cliente c join fetch c.endereco where c.nome like :nome");
    ...
    public Cliente pesquisarPorTelefone(String telefone, Session sessao) throws HibernateException {
        Query<Cliente> consulta = sessao.createQuery("from Cliente c join fetch c.pedidos where c.telefone = :telefone");
